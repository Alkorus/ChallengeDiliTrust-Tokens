 ...
 */
final class Version20220727210829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE token_api CHANGE token token VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE token_api CHANGE token token VARCHAR(255) NOT NULL');
