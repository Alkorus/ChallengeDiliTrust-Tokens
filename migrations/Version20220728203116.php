 ...
 */
final class Version20220728203116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE token_api CHANGE tag tag JSON DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE token_api CHANGE tag tag VARCHAR(255) DEFAULT NULL');
